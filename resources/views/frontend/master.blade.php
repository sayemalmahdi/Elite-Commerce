                        ...
                        <ul class="top-menu">
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="{{ route('admin.dashboard') }}" data-toggle=""><i class="icon-user"></i>Laravel Login</a></li>
                                </ul>
                            </li>
                        </ul><!-- End .top-menu -->
                    ...
                    <div class="header-left">
                        ...
                        <nav class="main-nav">
                            ...
                            <!-- <li class="megamenu-container active">
                                    <a href="{{ url('/')}}" class="ss-with-ul">Pages</a>
                            </li> -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="deal">
                                <div class="deal-content">
                                    ...
                                    <h2 style="color: #CC9965; font-size: 45px;">Deal of the Day</h2>
                        ...
                        <div class="deal-image">
                                    <a href="#">
                                        ...
                                        <!-- <img src="{{ asset('frontend')}}/assets/images/demos/demo-2/blog/post-1.jpg" alt="image"> -->
                                        <img src="{{ asset('frontend')}}/assets/images/slider/slide-3-480w.jpg" alt="image">
                                    </a>
                                </div>
                            </div><!-- End .banner -->
