    ...
    ***********************************-->
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                    <h4 class="card-title">Site Rating</h4>
                                    ...
                                    <div class="tab-content tab-content-default">
                                        ...
                                        <div class="tab-pane fade" id="info1">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="media">
                                                        <img src="{{ asset('backend')}}/assets/images/avatar/1.jpg" width="35" alt="reviewer">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="media mt-4">
                                                        <img src="{{ asset('backend')}}/assets/images/avatar/2.jpg" width="35" alt="reviewer">
                                                        <div class="media-body ml-4">
                                                            <div class="d-flex justify-content-between">
                                                                <strong>Antony Jonus</strong>
                                                                <div class="vertical-card__menu--rating c-pointer">
                        ...
                        <div class="card top_menu_widget">
                            <div class="card-body">
                                ...
                                <div class="media border-bottom pt-3 pb-3">
                                    <img width="50" height="50"  alt="#" class="mr-3" src="{{ asset('backend')}}/assets/images/menu/menu1.png">
                                ...
                                <div class="media border-bottom pt-3 pb-3">
                                    <img width="50" height="50"  alt="#" class="mr-3" src="{{ asset('backend')}}/assets/images/menu/menu2.png">
                                    <div class="media-body">
                                ...
                                <div class="media border-bottom pt-3 pb-3">
                                    <img width="50" height="50"  alt="#" class="mr-3" src="{{ asset('backend')}}/assets/images/menu/menu3.png">
                                    <div class="media-body">
                                ...
                                <div class="media border-bottom pt-3 pb-3">
                                    <img width="50" height="50"  alt="#" class="mr-3" src="{{ asset('backend')}}/assets/images/menu/menu4.png">
                                    <div class="media-body">
                                ...
                                <div class="media border-bottom pt-3 pb-3">
                                    <img width="50" height="50"  alt="#" class="mr-3" src="{{ asset('backend')}}/assets/images/menu/menu5.png">
                                    <div class="media-body">
                                ...
                                <div class="media pt-3 pb-3">
                                    <img width="50" height="50"  alt="#" class="mr-3" src="{{ asset('backend')}}/assets/images/menu/menu6.png">
                                    <div class="media-body">
                    ...
                    <div class="col-lg-4 col-xxl-4">
                        <div class="card performence_score">
                            <div class="card-body">
                                ...
                                <div id="activity">
                                    <div class="media border-bottom pt-3 pb-3">
                                        <img src="{{ asset('backend')}}/assets/images/avatar/1.jpg" alt="avatar" class="mr-3">
                                        <div class="media-body">
                                    ...
                                    <div class="media border-bottom pt-3 pb-3">
                                        <img src="{{ asset('backend')}}/assets/images/avatar/2.jpg" alt="avatar" class="mr-3">
                                        <div class="media-body">
                                    ...
                                    <div class="media border-bottom pt-3 pb-3">
                                        <img src="{{ asset('backend')}}/assets/images/avatar/3.jpg" alt="avatar" class="mr-3">
                                        <div class="media-body">
                                    ...
                                    <div class="media border-bottom pt-3 pb-3">
                                        <img src="{{ asset('backend')}}/assets/images/avatar/4.jpg" alt="avatar" class="mr-3">
                                        <div class="media-body">
                                    ...
                                    <div class="media border-bottom pt-3 pb-3">
                                        <img src="{{ asset('backend')}}/assets/images/avatar/5.jpg" alt="avatar" class="mr-3">
                                        <div class="media-body">
                                    ...
                                    <div class="media border-bottom pt-3 pb-3">
                                        <img src="{{ asset('backend')}}/assets/images/avatar/6.jpg" alt="avatar" class="mr-3">
                                        <div class="media-body">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img src="{{ asset('backend')}}/assets/images/avatar/7.jpg" alt="avatar" class="mr-3">
                                        <div class="media-body">
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p><a href="{{ url('/') }}">Elite-Commerce Site</a></p>
            </div>
        </div>
        <!--**********************************
            Footer end
